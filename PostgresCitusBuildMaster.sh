...
docker exec $containerName bash -c "psql -U postgres -c \"SELECT citus_add_node('10.100.100.33', 5432);\""
docker exec $containerName bash -c "psql -U postgres -c \"SELECT citus_add_node('10.100.100.32', 5432);\""
